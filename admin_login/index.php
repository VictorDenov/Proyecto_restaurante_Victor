...
<div class="login-box">
  <div class="login-logo">
    <a href="../admin/index2.html"><b>JDV </b><br></a>
  </div>
  <div class="card">
    <div class="card-body login-card-body">
      ...
      <form action="admin_login_check.php" method="post" autocomplete="off" onsubmit="return ValidateForm()">
        <div class="input-group mb-3">
          <input type="text" class="form-control" placeholder="Usuario" name="ad_username" id="ad_username">
        ...
        <div class="input-group mb-3">
          <input type="password" class="form-control" placeholder="contraseña" name="ad_password" id="ad_password">
          <div class="input-group-append">
            <div class="input-group-text">
  ...
  <p class="mb-1">
        <a href="admin_forgotpassword.php">Contraseña olvidada</a>
      </p> 
