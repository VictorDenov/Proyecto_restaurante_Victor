...
(1, 'Dylan', 8660557946, 'praveen@gmail.com', 'hubli', 'dylan24', '12345', '2020-03-03');

-- --------------------------------------------------------

--
-- Table structure for table `branch` sucursal
--
...
--
-- Table structure for table `customer o cliente`
--
...
--
-- Table structure for table `dealers o distribuidores`
--
...
--
-- Table structure for table `employee o empleado`
--
...
--
-- Indexes for table `customer_invoice o favtura cliente`
--
ALTER TABLE `customer_invoice`
  ADD PRIMARY KEY (`ci_id`);

--
-- Indexes for table `dealers o distribuidores`
--
ALTER TABLE `dealers`
