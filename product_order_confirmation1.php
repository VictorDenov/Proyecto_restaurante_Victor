...
$sql=$conn->prepare("INSERT INTO factura_cliente(cus_id,ci_order_no,b_name,ci_shipping_address,ci_landmark,ci_delivery_charges,ci_total_price,cus_contact,ci_date,ci_payment_mode,ci_transaction_no,ci_status,ci_cgst_percent,ci_cgst,ci_sgst_percent,ci_sgst,ci_sub_total)VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
