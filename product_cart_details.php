...
$cart_status="CART";    
$sql=$conn->prepare("SELECT * FROM detalles_carrito_producto  pcd,cliente c,detalles_producto pd,detalles_inventario s WHERE pd.pd_id=s.pd_id AND pcd.cus_id=c.cus_id AND pcd.pd_id=pd.pd_id AND c.cus_id=? AND pcd.pcd_estado=?");
...
<!--                        <th>Discout</th>-->
            ...
            <?php 
                                    ...
                                    $total_amount=$total_amount+$row['pcd_monto_total'];
                                    ?>
                    <tr>
                       ...
                       <?php echo $sl++; ?>
                        ...
                        <td class="product-name">
                        <?php echo $row["pcd_nombre"];?></td>
                        <td class="product-price-cart">
                        <span class="amount">&#8377; <?php echo $row["sd_precio_unitario"];?></span></td>
<!--
...
-->
                        ...
                        <td class="product-quantity">
                            <div class="pro-dec-cart">
                                <input class="cart-plus-minus-box" type="number" name="update_qty" id="update_qty" value="<?php echo $row["pcd_cantidad"];?>" min="5" max="<?php echo $max_stock_qty;?>">
                            </div>
                        </td>
                        ...
                        <td class="product-remove">
                            ...
                            <input type="hidden" name="sd_unit_price" id="sd_unit_price" value="<?php echo $row['sd_precio_unitario'];?>">
                            <input type="hidden" name="sd_discount" id="sd_discount" value="<?php echo $row['sd_descuento'];?>">
...
<?php 
$sql3=$conn->prepare("SELECT * FROM cargos_extra");
$sql3->execute();
...
$min_total_amount=$row3["monto_minimo"];
$delivery_charges=$row3["cargos_entrega"];
