      ...
      <div class="row">
        ...
        <div class="col-md-6">
          ...
          <div class="box box-primary">
           ...
           // $pc_id=$_POST['pc_id'];
           $sql=$conn->prepare("SELECT * FROM categoria_producto WHERE pc_id=?");
          ...
          ?>
            ...
            <div class="form-group">
                ...
                <input type="text" id="pc_name" name="pc_name" class="form-control"  value="<?php echo $row['pc_nombre'];?>"> 
            ...
            <div class="form-group">
                ...
                <img src="photos/<?php echo $row['pc_imagen']; ?>" alt="NO IMAGE" width="100" height="100"><br><br>
           <input type="hidden" name="old_pc_image" id="old_pc_image"   value="<?php echo $row['pc_imagen']; ?>">
