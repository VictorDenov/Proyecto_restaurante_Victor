    ...
    <section class="content">
      <div class="row">
        ...
        <div class="col-md-6">
         ...
         $sql=$conn->prepare("SELECT * from detalles_producto");
         $sql->execute();
         ...
         ?>
            ...
            <div class="form-group">
                <label for="inputEmail" class="control-label">Unit Price</label>
                 <input type="number" id="sd_unit_price" name="sd_unit_price"  value="<?php echo $row1['pd_precio']; ?>" class="form-control" onkeyup="sum();" >
