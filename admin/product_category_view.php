        ...
        <div class="col-12">
          ...
          <div class="card">
            <div class="card-header">
              ...
              <button class="btn btn-default" onclick="window.location.href='product_category_form.php'; "><i class="fas fa-plus"></i>&ensp;<th>New Record</th></button>
            </div>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
...
<?PHP
  require("database_connectivity.php");
      $sql=$conn->prepare("SELECT * FROM categoria_producto");
      $sql->execute();
...
?>
  <tr>
    ...
    <td><img src="photos/<?php echo $row["pc_imagen"];?>" alt="" height="100" width="100"></td>
    <td><?php echo $row["pc_fecha"];?></td>
