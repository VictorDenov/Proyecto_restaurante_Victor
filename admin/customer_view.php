...
?>
  ...
  <tr>
    ...
    <td><?php echo $row["cus_contacto"];?></td>
    <td><?php echo $row["cus_direccion"];?></td>
    <td><?php echo $row["cus_correo_electronico"];?></td>
    <td><?php echo $row["cus_nombre_usuario"];?></td>
    <td><?php echo $row["cus_password"];?></td>
    <td><?php echo $row["cus_fecha"];?></td>
    <!-- <td>
