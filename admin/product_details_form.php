          ...
          <div class="box box-primary">
            ...
            <form role="form" action="product_details_insert.php" method="post" enctype="multipart/form-data" onsubmit="return ValidateForm()">
              <div class="box-body">
                ...
                <label for="inputName1" class="control-label">categoria producto</label>
                   <select name="pc_id" id="pc_id" class="form-control" >
           	<option value="">--Select--</option>
           	<?php
			   require('database_connectivity.php');
			   $sql1=$conn->prepare("select * from categoria_producto");
			   $sql1->execute();
            ...
            <div class="form-group" >
           	...
           	<?php
			   require('database_connectivity.php');
			   $sql1=$conn->prepare("select * from subcategoria_producto");
			   $sql1->execute();
			   $result1=$sql1->get_result();
			   while($row1=$result1->fetch_assoc())
			   {
