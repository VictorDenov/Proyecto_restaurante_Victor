...
$pc_id=$_POST["pc_id"];
$psc_id=$_POST["psc_id"];
$pd_name=$_POST["pd_nombre"];
$pd_description=$_POST["pd_descripcion"];
$pd_price=$_POST["pd_precio"];
$pd_date=$_POST["pd_fecha"];
...
$sql=$conn->prepare("UPDATE product_details SET pc_id=?,psc_id=?,pd_nombre=?,pd_descripcion=?,pd_precio=?,pd_image1=?,pd_fecha=? WHERE pd_id=?");
