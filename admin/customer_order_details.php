      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <?php
            ...
            $ci_id=$row["ci_id"];
            $ci_order_no=$row['ci_numero_pedido'];
            $cus_id=$row['cus_id'];
            $cus_name=$row['cus_nombre'];
            $cus_address=$row['cus_direccion'];
            $cus_contact=$row['cus_contacto'];
            $cus_email=$row['cus_correo_electronico'];
            $ci_shipping_address=$row['ci_direccion_envio'];
            $ci_landmark=$row['ci_punto_referencia'];
            $ci_city=$row['ci_ciudad'];
            $ci_pin=$row['ci_codigo_postal'];
            $ci_state=$row['ci_estados'];
            $ci_country=$row['ci_ciudad'];
            $ci_status=$row['ci_estado'];
            $ci_date=$row['ci_fecha'];

            $sql2=$conn->prepare("SELECT * FROM sucursal");
            $sql2->execute();
            $result2=$sql2->get_result();
            $row2=$result2->fetch_assoc();
            $b_id=$row2['b_id'];
            $b_name=$row2['b_nombre'];
            $b_address=$row2['b_direccion'];
