...
$sql=$conn->prepare("INSERT INTO factura_cliente(cus_id,b_id,ci_order_no,ci_shipping_address,ci_landmark,ci_city,ci_pin,ci_state,ci_country,ci_delivery_charges,ci_contact_no,ci_date,ci_payment_mode,ci_transaction_no,ci_subtotal,ci_tax,ci_total_discount,ci_grand_total,ci_status)VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
...
$sql1=$conn->prepare("UPDATE detalles_carrito_producto SET pcd_estado=?,pcd_fecha=? WHERE cus_id=? AND pcd_estado=?");
