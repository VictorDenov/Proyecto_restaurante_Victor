      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
          	<p class="breadcrumbs"><span class="mr-2"><a href="index.html">Inicio</a></span> <span>Pedido</span></p>
        ...
        <div class="row justify-content-center">
          <div class="col-xl-7 ftco-animate">
						...
						<form action="#" class="billing-form" >
							<h3 class="mb-4 billing-heading">Datos de facturación</h3>
                ...
                <div class="w-100"></div>
                <br>
                <h3 class="mb-4 billing-heading">Detalles de envío</h3>

                <div class="col-md-12">
		            	<div class="form-group">
		            		<label for="country" >Tienda </label>
...
?>
		            ...
		            <div class="col-md-6">
	                  ...
	                  <input type="text" class="form-control" placeholder="Número de casa, apartamento y calle" name="ci_shipping_address" id="ci_shipping_address" required="">
		            ...
		            <div class="col-md-6">
		            	<div class="form-group">
	                  <input type="text" class="form-control" placeholder="Zona, sector, punto de referencia, etc." name="ci_landmark" id="ci_landmark" required="">
		            ...
		            <div class="col-md-6">
	                  ...
	                  <input type="text" class="form-control" placeholder="" name="ci_city" id="ci_city" required autocomplete="off">
		            ...
		            <div class="col-md-6">
		            	<div class="form-group">
		            		<label for="pin">Código postal</label>
		            ...
		            <div class="col-md-6">
		            	<div class="form-group">
		                  ...
		                  <select name="ci_state" id="ci_state" class="form-control" required="">
		                  	<option value="">--Seleccione--</option>
		                  	<option value="Karnataka">Chimborazo</option>
		                  </select>
		            ...
		            <div class="col-md-6">
	                  ...
	                  <input type="text" class="form-control" placeholder="" name="ci_country" id="ci_country" value="Ecuador" readonly>
 ...
 ?> -->
	          	...
	          	<div class="col-md-12 d-flex mb-5">
	          		<div class="cart-detail cart-total p-3 p-md-4">
	          			<h3 class="billing-heading mb-4">Carrito Total</h3>
	          			<p class="d-flex">
		    						<span>Subtotal</span>
...
?>
    ...
    <div class="col-md-12">
    	<div class="cart-detail p-3 p-md-4">
                <div class="checkout-form-list">
                    <h3 class="billing-heading mb-4">Forma de pago</h3>
                    <select class="form-control" id="payment_mode" name="payment_mode" required="">
                    <option value="" id = "COD">--Seleccionar--</option>
                    <option value="COD" id = "cod">Contra reembolso</option>
    ...
    <div class="checkout-form-list" id="showTRANID">
        ...
        <input type="text" name="ci_transaction_no" value="1" id="ci_transaction_no" placeholder="Transaction Number" class="form-control" required="">
...
<input type="hidden" name="grand_total" id="grand_total" value="<?php echo $row1['grand_total']; ?>"> -->
         ...
         <label>&nbsp;</label><br>
            <button type="submit" class="btn btn-primary py-3 px-4"><span>Realizar pedido</span></button>
        </div>
    </div>
